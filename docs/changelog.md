...
由于最近几次程序更新都遇到很多不兼容的改动，觉得心累，所以把文档的程序从 VuePress 2.x 迁移到 VitePress 1.x ，至少和我所在的团队使用的文档程序保持一致，有什么问题也不用每次都单独花时间来处理。

阅读体验上我个人感觉也好了不少，默认主题的暗黑模式也更舒服了一些，如果觉得有什么不方便的话可以给我发邮件或者提 issue 。
