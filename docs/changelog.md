...
2. 由于原来的 “起步准备” 一章内容有点太长，这一次续写拆分了一下内容，重新划分为单独的三章，分别是：
...
3. 在 “了解前端工程化” 一章里，新增了 [Vue.js 与工程化](engineering.md#vue-js-与工程化) 一节，作为两个大知识点之间的衔接，包含了：
   - [了解 Vue.js 与全新的 3.0 版本](engineering.md#了解-vue-js-与全新的-3-0-版本)
   - [Vue 与工程化之间的关联](engineering.md#vue-与工程化之间的关联)
   - [选择 Vue 入门工程化的理由](engineering.md#选择-vue-入门工程化的理由)
4. 在 “了解前端工程化” 一章里，完善了 [工程化的构建工具](engineering.md#工程化的构建工具) 的内容
