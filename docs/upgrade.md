...
相信已经阅读过 [Vue.js 与工程化](engineering.html#vue-js-与工程化) 一节内容的开发者，可以轻松猜到本书接下来关于 Vue 3 的学习都将基于前端工程化展开，本章将介绍如何配置 Vue 3 的开发环境并创建基于前端工程化的 Vue 3 项目。
...
在 2022 年 2 月 7 日， Vue 3 代替了 Vue 2 成为 Vue 的默认版本，Vue 3 被指定为默认版本之后，有一些注意事项需要留意：
