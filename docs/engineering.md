...
1. 职场需求量大，容易找工作，几乎所有公司在招聘前端工程师的时候都要求会 Vue
2. 上手门槛低，会 HTML / CSS / JS ，就能够轻松上手 Vue 的组件开发

第一个原因我们在 [求职竞争上的优势](#求职竞争上的优势) 已有进行过说明，主要讲讲第二个原因，在 [Vue 与工程化之间的关联](#vue-与工程化之间的关联) 里提到了开发者可以编写 `.vue` 文件，这是一个 Vue 专属的文件扩展名，官方名称是 Single-File Component ，简称 SFC ，也就是单文件组件。
